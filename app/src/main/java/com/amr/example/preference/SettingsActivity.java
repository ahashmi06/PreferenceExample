...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.recommended_settings) {
            startActivity(new Intent(this, RecommendedSettingsActivity.class));
            return true;
        } else {
    ...
    public void onBuildHeaders(List<Header> target) {
        // uncomment the below line and comment the setContentView method call to fix the error:
        // IllegalArgumentException: No view found for id 0x102036e (android:id/prefs) for fragment NotificationPreferenceFragment{efb92ac #1 id=0x102036e}
